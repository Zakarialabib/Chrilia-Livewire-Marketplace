<div>
    ...
    <form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="mb-4 {{ $errors->has('subscription.details') ? 'is-invalid' : '' }}">
            ...
            <input class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500" type="text" name="subscription_details" id="subscription_details" required
