    ...
    <form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="flex flex-wrap -m-2">
            ...
            <div class="lg:w-1/2 sm:w-full p-2 {{ $errors->has('order.status') ? 'is-invalid' : '' }}">
                ...
                <select class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500" required id="order_status" name="order-status" wire:model="order.status">
