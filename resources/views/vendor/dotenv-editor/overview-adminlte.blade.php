...
<div class="box box-success box-solid">
  ...
  <div class="box-body" id="app">
    <h1><a href="{{ url(config('dotenveditor.subscription.prefix')) }}">{{ __('dotenv-editor::views.title') }}</a></h1>
    <div class="row">
      <div class="col-md-12">
      ...
      <div class="col-md-12 col-sm-12">
        ...
        <div v-show="views[2].active">
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <a href="{{ url(config('dotenveditor.subscription.prefix') . "/createbackup") }}" class="btn btn-primary">
                {!! __('dotenv-editor::views.backup_create') !!}
              </a>
              <a href="{{ url(config('dotenveditor.subscription.prefix') . "/download") }}" class="btn btn-primary">
              ...
              <table class="table table-striped">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-info" href="{{ url(config('dotenveditor.subscription.prefix') . "/download/" . $backup['unformatted']) }}">
                      <span class="fa fa-download" title="{!! __('dotenv-editor::views.backup_table_options_download') !!}"></span>
                    </a>
                    <a onclick="return confirm('are you sure?')" class="btn btn-danger" href="{{ url(config('dotenveditor.subscription.prefix') . "/deletebackup/" . $backup["unformatted"]) }}" title="{!! __('dotenv-editor::views.backup_table_options_delete') !!}">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <a onclick="return confirm('are you sure?')" href="{{ url(config('dotenveditor.subscription.prefix') . "/deletebackup/" . $backup["unformatted"]) }}" class="btn btn-danger">
        ...
        <div v-show="views[3].active">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form method="post" action="{{ url(config('dotenveditor.subscription.prefix') . "/upload") }}" enctype="multipart/form-data">
                <div class="form-group">
