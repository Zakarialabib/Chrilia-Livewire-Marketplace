<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="float-right p-2 mb-4">
        ...
        <a href="{{ route('admin.permissions.index') }}" class="btn rounded-md text-sm font-medium border-0 focus:outline-none focus:ring transition bg-gray-300 text-black hover:text-blue-800 hover:bg-blue-200 active:bg-blue-200 focus:ring-blue-300">
            {{ __('Go back') }}
        </a>
    </div>
</form>
