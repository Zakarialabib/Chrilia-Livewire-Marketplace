...
<th
    {{ $attributes->merge(['class' => 'p-3 text-left text-xs font-medium uppercase tracking-wider bg-gray-50 text-gray-700 dark:bg-gray-600 dark:text-gray-300'])->only('class') }}
>
    @unless ($sortable)
