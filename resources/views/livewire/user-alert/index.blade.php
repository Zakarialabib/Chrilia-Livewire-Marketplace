    ...
    <div class="p-4">
      ...
      <form wire:submit.prevent="deleteSelected">
        <x-modal.confirmation wire:model.defer="showDeleteModal">
            ...
            <x-slot name="footer">
                <button type="button" class="btn border-gray-300 text-gray-700 dark:text-gray-300 active:bg-gray-50 active:text-gray-800 hover:text-gray-500 active:bg-dark-eval-1 active:text-gray-300 hover:text-gray-700" wire:click="$set('showDeleteModal', false)">{{ __('Cancel') }}</button>
