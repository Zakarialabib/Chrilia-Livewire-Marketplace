<div>
    ...
    <form wire:submit.prevent="submit" class="pt-3">
        ...
        <div class="w-full p-2">
            ...
            <input class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500"  @error('order.code') border-red-600 @enderror" type="text" name="order-code"
