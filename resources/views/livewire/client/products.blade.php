<div>
    <div class="flex flex-wrap px-10">
        <div class="lg:w-1/2 md:w-1/2 sm:w-full flex flex-wrap my-md-0 my-2">
            ...
            <button class="leading-4 md:text-sm sm:text-xs bg-blue-900 text-white hover:text-blue-800 hover:bg-blue-100 active:bg-blue-200 focus:ring-blue-300 font-medium uppercase px-6 py-2 rounded-md shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        ...
        @forelse ($products as $product)
            <div class="overflow-hidden shadow-lg rounded-lg h-90 w-60 md:w-80 m-auto">
                ...
                @if ($product->image != null)
                    <img alt="{{ $product->name }}" loading="lazy" src="{{ asset('uploads/' . $product->image) }}"
                ...
                <div class="w-full p-4">
                    <p class="text-gray-400 font-light text-center text-md mb-4">
                        {{ $product->name }}
                    </p>
                    <div class="flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 sm:w-full text-right">
                            <div class="text-red-400 font-bold text-md mr-2">
