    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data">
        ...
        <div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="w-3/4">
                            <div class="mb-4 @error('logoFile') has-error @enderror">
                                ...
                                <input class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500" type="file" wire:model="logoFile"
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="w-3/4">
                            <div class="mb-4 @error('iconFile') has-error @enderror">
                                ...
                                <input class="p-3 leading-5 bg-white dark:bg-dark-eval-2 text-gray-700 dark:text-gray-300 rounded border border-gray-300 mb-1 text-sm w-full focus:shadow-outline-blue focus:border-blue-500" type="file" wire:model="iconFile" />
            ...
            <div class="float-right p-2 mb-4">
                <button type="submit"
                    class="md:text-sm sm:text-xs bg-blue-900 text-white hover:text-blue-800 hover:bg-blue-100 active:bg-blue-200 focus:ring-blue-300 text-sm font-bold uppercase px-6 py-2 rounded-md shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150 w-full">{{ __('Update') }}</button>
            </div>
        </div>
    </form>
</div>
