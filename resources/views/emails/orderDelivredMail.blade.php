                ...
                <table align="center" border="0" bordercolor="#f6fafb" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td align="center" style="padding: 40px 0 30px 0;">
                            <img src="{{ asset('uploads/' . config('settings.site_logo')) }}" alt="{{ config('settings.company_name') }}" width="190px"
                                height="90px">
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    <td
                                        ...
                                        <p>
                                        <h3><strong>{{ __('Order Tracking') }}</strong></h3>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        ...
                                        {{ __('Hello') }}, <strong>{{ $order->client->name }}</strong>
                                    </td>
                                </tr>
                                <tr>
                                    <td
                                        style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 5px 0 0px 0;">
                                        <p>
                                            {{ __('Your delivery has been deliveried') }}. <br>
                                            {{ __('Please check your dashboard to track changes') }}.
                                        </p>
                                    </td>
                                </tr>
                            </table>
