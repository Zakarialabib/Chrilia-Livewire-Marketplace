...
<div id="app">
  ...
  <div class="container">
    <h1><a href="{{ url(config('dotenveditor.subscription.prefix')) }}">{{ trans('dotenv-editor::views.title') }}</a></h1>
        ...
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              ...
              <a href="{{ url(config('dotenveditor.subscription.prefix') . "/download/" . $backup['unformatted']) }}">
                <span class="glyphicon glyphicon-download" title="{!! trans('dotenv-editor::views.backup_table_options_download') !!}"></span>
              </a>
              <a href="{{ url(config('dotenveditor.subscription.prefix') . "/deletebackup/" . $backup["unformatted"]) }}" title="{!! trans('dotenv-editor::views.backup_table_options_delete') !!}">
    ...
    <div class="modal fade" id="showDetails" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <a href="{{ url(config('dotenveditor.subscription.prefix') . "/deletebackup/" . $backup["unformatted"]) }}" class="btn btn-danger">
