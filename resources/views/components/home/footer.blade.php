<div class="relative bg-indigo-600">
    <div class="max-w-screen-xl mx-auto py-5 px-4 sm:px-6 lg:py-6 lg:px-8">
        <div class="grid grid-cols-3 gap-8  items-center">
            <div class="col-span-1">
                ...
                <div class="mt-8 flex justify-center w-full">
                    ...
                    <a href="{{ config('settings.social_facebook') }}" target="_blank"
                        class="text-white hover:text-blue-500"><span class="sr-only">{{ __('Facebook') }}</span>
                    ...
                    <a href="{{ config('settings.social_linkedin') }}" target="_blank"
                        class="ml-6 text-white hover:text-blue-500"><span class="sr-only">Linkedin</span> <svg
                            fill="currentColor" viewBox="0 0 28 28" class="h-6 w-6">
                            <path
            ...
            <div class="mt-12 grid grid-cols-1 gap-8 col-span-2 ">
                <div class="md:grid md:grid-cols-2 md:gap-8 ">
                    ...
                    <div class="mt-12 md:mt-0 text-center relative">
                        <ul class="mt-4 inline-block align-middle">
                            @guest
